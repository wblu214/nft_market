...
- ABI 文件位置（在本倉庫內）：
  - `NFTMarketplace`：`out/NFTMarketplace.sol/NFTMarketplace.json`
  - `ProjectNFT`：`out/ProjectNFT.sol/ProjectNFT.json`
  - `Project1155`：`out/Project1155.sol/Project1155.json`
